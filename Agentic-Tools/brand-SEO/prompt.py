...
3) Call search_result_agent for the top keyword and relay response
   ...
   - Input fields: keyword (top_keyword), brand (brand_name)
   ...
   <example>
       input table columns: keyword, rank
       kids shoes, 1
       running shoes, 2
       output: call search_result_agent with keyword = kids shoes
   </example>
...
5) Call comparison_root_agent to get a report
   ...
   - Input fields: brand (brand_name), competitors (competitor_domains), keyword (top_keyword)
